package com.example.roomdb_03_tata
...
import com.example.roomdb_03_tata.databinding.ActivityMainBinding
import com.example.roomdb_03_tata.room.Constant
import com.example.roomdb_03_tata.room.Movie
import com.example.roomdb_03_tata.room.MovieDb
...
class MainActivity : AppCompatActivity() {
    ...
    private fun deleteDialog(movie : Movie){
        ...
        alertDeleteDialog.apply {
            ...
            setMessage("Catatan ini akan dihapus ${movie.title} ?")
